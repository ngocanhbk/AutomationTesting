...
public class TestGenerator {
	...
	public static void printParameters() {
		System.out.println("populationSize: " + Common.populationSize);
		System.out.println("maxAttemptsPerTarget: " + Common.maxLoop);
	...
	public Population minimizeTestCases(Population pop) {
		...
		for (String s : MainGA.inputs) {
			TestGenerator.targetFile = Common.relativePath + s + ".tgt";
			TestGenerator.pathsFile = Common.relativePath + s + ".path";
	...
	public void printJunitFileFirst(Population pop) {
		try {
			...
			PrintStream out = new PrintStream(new FileOutputStream(Common.relativePath + junitFile));
