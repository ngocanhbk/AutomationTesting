...
public class Population {
	 ...
	 * trong quần thể
	 */
	public static int populationSize = Common.populationSize;
	...
	public static Population generateRandomPopulation() throws IOException {
		...
		for (int j = 0; j < Population.populationSize; j++) {
			...
			chromosomeFormer.caculateApproadLevel(curTarget);
		}
	...
	public Population selection() {
		int numberSelection = (int) (populationSize * Common.cumulativeProbability);
	...
	public void crossover() throws IOException {
		int x = (int) (populationSize * Common.cumulativeProbability / 2);
	...
	public void mutation() throws IOException {
		int x = (int) (populationSize * Common.mutationProbability);
		for (int i = 0; i < x; i++) {
