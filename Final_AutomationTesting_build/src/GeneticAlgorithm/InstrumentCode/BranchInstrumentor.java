...
public class BranchInstrumentor extends openjava.mop.OJClass {
	...
	public static final String relativePath = "..\\Final_AutomationTesting\\src\\";
	...
	public void insertBranchTraces(openjava.ptree.StatementList block) {
		try {
			block.accept(new GeneticAlgorithm.InstrumentCode.BranchTraceVisitor(this));
	...
	private void openOutputFiles() {
		try {
			signatureFile = new java.io.PrintStream(
					new java.io.FileOutputStream(relativePath + className + ".sign"));
			targetFile = new java.io.PrintStream(
					new java.io.FileOutputStream(relativePath + className + ".tgt"));
